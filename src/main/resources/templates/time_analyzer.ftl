...
<body>
    ...
    <div class="w3-content w3-container w3-padding-64" id="loggedTime">
    ...
    <div class="parallax small-img-users-1 w3-display-container w3-opacity-min" id="home">
        <div class="w3-display-middle" style="white-space:nowrap;">
    ...
    <div class="w3-content w3-container w3-padding-64" id="charts">
